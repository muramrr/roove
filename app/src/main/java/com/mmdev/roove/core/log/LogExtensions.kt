...
import com.mmdev.roove.core.RooveApp

fun logWarn(tag: String = "mylogs", message: String) =
	RooveApp.debug.logger.logWarn(tag, message)
fun logWarn(clazz: Class<Any>, message: String) =
	com.mmdev.data.core.log.logWarn("mylogs_${clazz.simpleName}", message)



fun logError(tag: String = "mylogs", message: String) =
	RooveApp.debug.logger.logError(tag, message)
...
fun logDebug(tag: String = "mylogs", message: String) =
	RooveApp.debug.logger.logDebug(tag, message)
...
fun logInfo(tag: String = "mylogs", message: String) =
	RooveApp.debug.logger.logInfo(tag, message)
...
fun logWtf(tag: String = "mylogs", message: String) =
	RooveApp.debug.logger.logWtf(tag, message)

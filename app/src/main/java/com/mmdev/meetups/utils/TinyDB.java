...
public class TinyDB
{
	 ...
	 *
	 * @param key SharedPreferences key
     * @param defValue   default value if not exist
	 * @return String value at 'key' or "" (empty String) if key not found
	 */
	public String getString (String key, String defValue) { return preferences.getString(key, defValue); }
	...
	public ArrayList<Boolean> getListBoolean (String key)
	{
		...
		{
			if (item.equals("true")) newList.add(true);
